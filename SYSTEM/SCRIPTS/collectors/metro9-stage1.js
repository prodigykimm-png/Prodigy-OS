...
/**
 * metro9-stage1 — zero-network typed provider adapter stub
 * Provider: metro9-stage1
 * Operator: 서울9호선운영(주)
 * Scope: 9호선 1단계 stations only
 * Source: https://www.metro9.co.kr/
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Separate operator/address/raw fixture for stage1 not yet reviewed
 *
...
const PROVIDER_ID = "metro9-stage1";
const OPERATOR = "서울9호선운영(주)";
const SCOPE = "9호선 1단계 stations only";
const SOURCE_URL = "https://www.metro9.co.kr/";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Separate operator/address/raw fixture for stage1 not yet reviewed";
