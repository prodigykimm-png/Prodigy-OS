 ...
 * molit-apt-rent.js
 *
 * MOLIT apartment rent transaction adapter (FAIL-CLOSED).
 ...
 * Same blocked rule as sale; external comparables remain "정보 확인 불가",
 * never estimated.
 *
...
const PROVIDER_ID = "molit_apt_rent";
const REGISTRY_STATUS = "blocked_fixture";
const DATASET_ID = "15126474";
...
const INTENDED_SCOPE = Object.freeze({
  ...
  deal_ymd: "DEAL_YMD",
  measures: ["deposit KRW", "rent KRW", "area m2", "date", "official ID"],
});
...
function dispatch() {
  return Object.freeze({
    ...
    error: "molit_apt_rent: dispatch forbidden while blocked_fixture; zero network",
  });
}
...
function parseResponse() {
  return Object.freeze({
    ...
    error: "molit_apt_rent: parser not implemented while blocked_fixture",
  });
}
