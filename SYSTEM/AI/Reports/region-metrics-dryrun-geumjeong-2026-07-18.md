...
- local raw: `/tmp/region-dryrun-geumjeong/raw/15106861.csv`
...
- local raw: `/tmp/region-dryrun-geumjeong/raw/15111714.csv`
...
Current local dry-run raw only under `/tmp/region-dryrun-geumjeong/` (ephemeral).
