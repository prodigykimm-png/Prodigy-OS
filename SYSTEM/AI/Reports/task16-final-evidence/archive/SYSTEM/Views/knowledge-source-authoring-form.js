(function (root) {
  ...
  function renderClassificationFields(form, controller, draft, disabled) {
    ...
    control(form, controller, { name: "connections", label: "연결 Region", value: Array.isArray(draft.connections) ? draft.connections.join(", ") : "", disabled,
      tag: "input" });
    createEl(form, "p", { text: "정확한 Region wikilink만 입력하세요. 본문·좌표·모호한 지명은 Region link를 만들지 않습니다.", attr: { class: "knowledge-source-authoring-help", style: "margin:2px 0;color:var(--text-muted);" } });
  }
