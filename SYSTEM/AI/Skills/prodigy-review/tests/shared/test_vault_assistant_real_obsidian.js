...
async function runJourneys(harness) {
  ...
  record("S08a", "malformed citation", "real Obsidian runtime boundary", "fake runtime malformed; submit", "invalid response with explicit retry and no ungrounded answer", { state, text: view.text }, state === "error" && view.text.includes("invalid_response"), [ref]);
  ...
  record("S08b", "unknown citation", "real Obsidian runtime boundary", "set unknown-citation mode; click retry", "invalid response and no ungrounded answer", { state, text: view.text }, state === "error" && view.text.includes("invalid_response") && !view.text.includes("unknown\n"), [ref]);
