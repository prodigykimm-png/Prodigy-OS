...
function buildFixture(runtimeRoot, mutation = {}) {
  ...
  if (mutation.prodigyAIRuntimePluginPath) {
    ...
    if (mutation.prodigyAIRuntimeDataPath) {
      fs.copyFileSync(path.resolve(String(mutation.prodigyAIRuntimeDataPath)), path.join(runtimeTarget, "data.json"));
    }
