...
.prodigy-list-workspace{max-width:980px;margin:0 auto;padding:8px 8px 48px}.workspace-list-header{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;padding:8px 0 22px;border-bottom:1px solid var(--background-modifier-border)}.workspace-list-title h1{margin:0;font-size:1.5em;letter-spacing:0}.workspace-list-title p{margin:5px 0 0;color:var(--text-muted);font-size:.84em;line-height:1.45}.workspace-list-actions{display:flex;gap:8px;flex-wrap:wrap}.workspace-list-section{padding:22px 0 6px}.workspace-list-section h2{font-size:1.02em;margin:0 0 12px}.workspace-list-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:16px;align-items:center;padding:13px 0;border-top:1px solid var(--background-modifier-border)}.workspace-list-copy{min-width:0}.workspace-list-copy strong{display:block;overflow-wrap:anywhere}.workspace-list-name{display:inline;font-weight:700;overflow-wrap:anywhere;color:var(--text-accent);cursor:pointer;text-decoration:none;border-bottom:1px solid transparent}.workspace-list-name:hover{border-bottom-color:var(--text-accent)}.workspace-list-name:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px;border-radius:2px}.workspace-list-meta{display:flex;gap:8px;flex-wrap:wrap;margin-top:4px;color:var(--text-muted);font-size:.76em}.workspace-list-detail{margin-top:5px;color:var(--text-muted);font-size:.8em;line-height:1.45;overflow-wrap:anywhere}.workspace-list-empty{padding:18px 0;color:var(--text-muted);font-size:.84em}.workspace-list-count{margin-left:6px;color:var(--text-muted);font-weight:500;font-size:.78em}.workspace-list-row-actions{display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end;align-items:center}.workspace-list-actions button,.workspace-list-row-actions button{min-height:32px}@media(max-width:600px){.prodigy-list-workspace{padding:4px 4px 40px}.workspace-list-header{align-items:stretch;flex-direction:column}.workspace-list-actions{display:grid;grid-template-columns:1fr}.workspace-list-row{grid-template-columns:1fr;gap:10px}.workspace-list-row-actions{justify-self:stretch;display:grid;grid-template-columns:1fr 1fr;gap:6px}.workspace-list-title h1{font-size:1.3em}.workspace-list-actions button,.workspace-list-row-actions button{min-height:44px}}
` });
