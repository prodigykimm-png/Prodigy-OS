...
/**
 * gimpo-goldline — zero-network typed provider adapter stub
 * Provider: gimpo-goldline
 * Operator: 김포골드라인운영(주)
 * Scope: 김포골드라인 stations
 * Source: https://gimpogoldline.com/?page_id=505
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Station-code/name uniqueness and address fixture not yet verified
 *
...
const PROVIDER_ID = "gimpo-goldline";
const OPERATOR = "김포골드라인운영(주)";
const SCOPE = "김포골드라인 stations";
const SOURCE_URL = "https://gimpogoldline.com/?page_id=505";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Station-code/name uniqueness and address fixture not yet verified";
