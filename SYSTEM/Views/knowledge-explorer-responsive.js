...
.knowledge-explorer-pane-title h2, .knowledge-explorer-pane-title h3, .knowledge-explorer-brief-panel h3, .knowledge-explorer-asset-section h3 { font-size:var(--ke-type-title); line-height:var(--ke-leading-control); letter-spacing:0; }
...
.knowledge-explorer-group-title { color:var(--ke-color-muted); font-size:var(--ke-type-label); line-height:var(--ke-leading-control); letter-spacing:0; }
.knowledge-explorer-button, .knowledge-explorer-open, .knowledge-explorer-back { display:inline-flex; align-items:center; justify-content:space-between; gap:var(--ke-space-2); min-inline-size:0; min-height:32px; padding:var(--ke-space-2) var(--ke-space-3); border:1px solid var(--ke-color-border); border-radius:var(--ke-radius-control); background:var(--ke-color-surface-secondary); color:var(--ke-color-text); font-size:var(--ke-type-label); line-height:var(--ke-leading-control); letter-spacing:0; cursor:pointer; transition:background-color var(--ke-motion-fast) ease,border-color var(--ke-motion-fast) ease,transform var(--ke-motion-fast) ease; }
