...
test("targetKey rejects absolute path", () => {
  assert.throws(() => identity.targetKey("/Users/test/file.md"), /상대 경로/);
});
...
test("canonicalRelativePath computes NFC relative path", () => {
  ...
  const abs = "/Users/test/Vault/PARA/RESOURCES/Auction Regions/부산광역시-사하구.md";
...
test("canonicalRelativePath rejects path outside vault", () => {
  assert.throws(() => identity.canonicalRelativePath("/Users/test/Vault", "/Users/other/file.md"), /밖에 있습니다/);
});
