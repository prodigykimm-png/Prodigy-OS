...
class RealObsidianHarness {
  ...
  async close(options = {}) {
    ...
    assert.equal(audit.equal, true, "vault bytes changed outside declared runtime metadata");
