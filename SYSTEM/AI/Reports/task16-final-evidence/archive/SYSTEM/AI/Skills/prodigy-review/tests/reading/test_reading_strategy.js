...
function main() {
  ...
  assert.ok(require(path.join(ROOT, "SYSTEM/AI/Skills/prodigy-review/tests/shared/fixtures/workspace-manifest-v1.json")).entries.reading.required.includes("SYSTEM/Views/reading-strategy-core.js"));
