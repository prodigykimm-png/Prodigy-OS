...
/**
 * ui-sinseol — zero-network typed provider adapter stub
 * Provider: ui-sinseol
 * Operator: 우이신설경전철(주)
 * Scope: 우이신설선 stations
 * Source: https://www.ui-line.com/html/main.php
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Current fetch failure remains blocked_runtime; exact detail URL fixture required
 *
...
const PROVIDER_ID = "ui-sinseol";
const OPERATOR = "우이신설경전철(주)";
const SCOPE = "우이신설선 stations";
const SOURCE_URL = "https://www.ui-line.com/html/main.php";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Current fetch failure remains blocked_runtime; exact detail URL fixture required";
