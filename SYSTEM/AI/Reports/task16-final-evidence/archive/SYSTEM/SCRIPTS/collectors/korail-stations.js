...
/**
 * korail-station-candidate — zero-network typed provider adapter stub
 * Provider: korail-station-candidate
 * Operator: 한국철도공사
 * Scope: Korail 수도권 rail stations
 * Source: https://www.kric.go.kr/jsp/board/portal/sub05/est/estationList.jsp
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Row-level Korail operator evidence required; KRIC alone does not prove operator
 *
...
const PROVIDER_ID = "korail-station-candidate";
const OPERATOR = "한국철도공사";
const SCOPE = "Korail 수도권 rail stations";
const SOURCE_URL = "https://www.kric.go.kr/jsp/board/portal/sub05/est/estationList.jsp";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Row-level Korail operator evidence required; KRIC alone does not prove operator";
