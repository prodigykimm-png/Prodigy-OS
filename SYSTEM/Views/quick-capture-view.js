(function (root) {
  ...
  function ensureQuickCaptureStyles() {
    ...
    style.textContent = [
      ...
      ".quick-capture-row button.quick-capture-trigger,.quick-capture-row button.quick-capture-save,.quick-capture-row button.quick-capture-cancel{min-block-size:var(--ke-touch-target,44px);min-height:var(--ke-touch-target,44px);height:auto!important;box-shadow:none!important;padding-inline:var(--ke-space-3,12px);border:1px solid var(--ke-color-border,var(--background-modifier-border));border-radius:var(--ke-radius-control,8px);background:var(--ke-color-surface,var(--background-primary));color:var(--ke-color-text,var(--text-normal));font-size:var(--ke-type-label,0.72rem)}",
      ...
      ".quick-capture-title,.quick-capture-input{inline-size:100%;max-inline-size:100%;min-block-size:var(--ke-touch-target,44px);min-height:var(--ke-touch-target,44px);box-sizing:border-box;box-shadow:none!important;padding:var(--ke-space-2,8px);border:1px solid var(--ke-color-border,var(--background-modifier-border));border-radius:var(--ke-radius-control,8px);background:var(--ke-color-surface,var(--background-primary));color:var(--ke-color-text,var(--text-normal));font-size:var(--ke-type-body,0.84rem);word-break:keep-all;overflow-wrap:anywhere}",
