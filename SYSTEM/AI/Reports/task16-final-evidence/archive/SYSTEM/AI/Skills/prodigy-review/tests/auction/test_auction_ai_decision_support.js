...
test("Given the Auction Hub loader, When the decision-support entry is wired, Then its pure core and UI load before the Region packet", () => {
  const corePath = "SYSTEM/Views/auction-decision-support-core.js";
  const aiCorePath = "SYSTEM/Views/auction-ai-decision-support-core.js";
  const uiPath = "SYSTEM/Views/auction-ai-decision-support.js";
  const packetPath = "SYSTEM/Views/auction-region-packet.js";
