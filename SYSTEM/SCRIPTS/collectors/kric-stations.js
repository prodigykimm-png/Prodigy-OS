...
/**
 * kric-station-candidate — zero-network typed provider adapter stub
 * Provider: kric-station-candidate
 * Operator: cross-operator
 * Scope: KRIC cross-operator candidate corpus
 * Source: https://data.kric.go.kr/rips/M_01_01/detail.do?id=32
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Provider/address/boundary evidence not yet passed; quarantine until validated
 *
...
const PROVIDER_ID = "kric-station-candidate";
const OPERATOR = "cross-operator";
const SCOPE = "KRIC cross-operator candidate corpus";
const SOURCE_URL = "https://data.kric.go.kr/rips/M_01_01/detail.do?id=32";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Provider/address/boundary evidence not yet passed; quarantine until validated";
