...
async function testExecProvidersRejectUnapprovedExecutionSettingsBeforeDispatch() {
  ...
  const attacks = [
    { adapter: "codex-exec", authMode: "codex-login", command: "<task-temp>/unapproved", sandbox: "read-only" },
    ...
    { adapter: "antigravity-exec", authMode: "antigravity-login", command: "<task-temp>/unapproved", sandbox: true },
