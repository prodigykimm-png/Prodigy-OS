(function (root) {
  ...
  function ensureStyle(container) {
    ...
    const style = createEl(container, "style", { text: `.llmwiki-approval-review{display:grid;gap:var(--ke-space-4);min-inline-size:0;color:var(--ke-color-text)}.llmwiki-approval-review *{box-sizing:border-box;min-inline-size:0}.llmwiki-approval-review header,.llmwiki-approval-review section,.llmwiki-approval-review article{display:grid;gap:var(--ke-space-2);min-inline-size:0}.llmwiki-approval-review h2,.llmwiki-approval-review h3,.llmwiki-approval-review h4,.llmwiki-approval-review p{margin:0;overflow-wrap:anywhere;word-break:keep-all}.llmwiki-approval-review h2{font-size:var(--ke-type-title);line-height:var(--ke-leading-control)}.llmwiki-approval-review h3{font-size:var(--ke-type-heading);line-height:var(--ke-leading-control)}.llmwiki-approval-review p,.llmwiki-approval-review dt,.llmwiki-approval-review dd,.llmwiki-approval-review li{font-size:var(--ke-type-body);line-height:var(--ke-leading-body);overflow-wrap:anywhere;word-break:keep-all}.llmwiki-approval-review dl{display:grid;grid-template-columns:minmax(6rem,auto) minmax(0,1fr);gap:var(--ke-space-2) var(--ke-space-3);margin:0}.llmwiki-approval-review dt{color:var(--ke-color-muted)}.llmwiki-approval-review dd{margin:0}.llmwiki-approval-review__meta,.llmwiki-approval-review__notice,.llmwiki-approval-review__operation{padding:var(--ke-space-3);border:1px solid var(--ke-color-border);border-radius:var(--ke-radius-panel);background:var(--ke-color-surface-secondary)}.llmwiki-approval-review__notice[data-state="error"],.llmwiki-approval-review__notice[data-state="stale"],.llmwiki-approval-review__conflict{color:var(--ke-color-error)}.llmwiki-approval-review__actions,.llmwiki-approval-review__operation-head,.llmwiki-approval-review__source{display:flex;flex-wrap:wrap;align-items:center;gap:var(--ke-space-2);min-inline-size:0}.llmwiki-approval-review button,.llmwiki-approval-review a{min-height:32px;padding:var(--ke-space-2) var(--ke-space-3);border:1px solid var(--ke-color-border);border-radius:var(--ke-radius-control);background:var(--ke-color-surface);color:var(--ke-color-text);font-size:var(--ke-type-label);line-height:var(--ke-leading-control);cursor:pointer;overflow-wrap:anywhere;word-break:keep-all}.llmwiki-approval-review button[data-primary="true"]{background:var(--ke-color-interactive);color:var(--ke-color-on-interactive);border-color:var(--ke-color-interactive)}.llmwiki-approval-review button:focus-visible,.llmwiki-approval-review a:focus-visible,.llmwiki-approval-review input:focus-visible{outline:2px solid var(--ke-color-accent);outline-offset:2px}.llmwiki-approval-review button:disabled{opacity:.5;cursor:not-allowed}.llmwiki-approval-review a{color:var(--ke-color-accent);text-decoration:none}.llmwiki-approval-review a:hover{text-decoration:underline}.llmwiki-approval-review__operations{display:grid;gap:var(--ke-space-3)}.llmwiki-approval-review__diff{border-top:1px solid var(--ke-color-border);padding-top:var(--ke-space-2)}.llmwiki-approval-review__diff-row{display:grid;grid-template-columns:minmax(4rem,auto) minmax(0,1fr);gap:var(--ke-space-2)}.llmwiki-approval-review__muted{color:var(--ke-color-muted)}.llmwiki-approval-review__scroll-owner{min-inline-size:0}.llmwiki-approval-review__operation input{min-width:18px;min-height:18px}.llmwiki-approval-review__actions button{min-height:var(--ke-touch-target)}@media(max-width:767px){.llmwiki-approval-review dl{grid-template-columns:1fr}.llmwiki-approval-review__actions button{flex:1 1 100%}}@media(prefers-reduced-motion:reduce){.llmwiki-approval-review *{transition:none!important;animation:none!important}}` });
  ...
  function renderOperation(parent, operation, state, callbacks) {
    const card = createEl(parent, "article", { attr: { class: "llmwiki-approval-review__operation", "data-operation-id": operation.operation_id } });
  ...
  function mountLlmWikiApprovalReview(options = {}) {
    ...
    function render() {
      ...
      const frame = createEl(container, "section", { attr: { class: "llmwiki-approval-review", "data-surface": "llmwiki-approval-review", "data-scroll-owner": "knowledge-hub-body", "aria-label": "Librarian 실행 검토", tabindex: "0" } });
      ...
      const meta = createEl(frame, "section", { attr: { class: "llmwiki-approval-review__meta" } });
