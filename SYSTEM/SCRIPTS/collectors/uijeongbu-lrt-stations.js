...
/**
 * uijeongbu-lrt — zero-network typed provider adapter stub
 * Provider: uijeongbu-lrt
 * Operator: 의정부경전철(주)
 * Scope: 의정부경전철 stations
 * Source: https://www.ulrt.co.kr/
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Official station detail not frozen; row stays candidate
 *
...
const PROVIDER_ID = "uijeongbu-lrt";
const OPERATOR = "의정부경전철(주)";
const SCOPE = "의정부경전철 stations";
const SOURCE_URL = "https://www.ulrt.co.kr/";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Official station detail not frozen; row stays candidate";
