(function (root) {
  ...
  async function renderDashboard(app, container, openProposeEvidenceModal, dashboardState, selectedDate) {
    ...
    container.createEl("style").textContent = `.prodigy-journal-workspace{max-width:920px;margin:0 auto;padding:8px 8px 40px;font-size:var(--ke-type-body,.84rem);line-height:var(--ke-leading-body,1.45);letter-spacing:0}.journal-card{border:1px solid var(--background-modifier-border);border-radius:8px;background:var(--background-secondary);padding:14px;margin-bottom:12px}.journal-card h2{margin:0 0 10px;font-size:var(--ke-type-heading,.92rem);line-height:var(--ke-leading-body,1.45);letter-spacing:0}.journal-meta{color:var(--text-muted);font-size:var(--ke-type-label,.72rem);line-height:var(--ke-leading-body,1.45);margin-bottom:8px}.journal-preview{font-size:var(--ke-type-body,.84rem);line-height:var(--ke-leading-body,1.45);color:var(--text-normal);white-space:pre-wrap}.journal-primary-actions{margin:var(--ke-space-3) 0}.journal-pending-delete .prodigy-btn{margin-left:var(--ke-space-3)}.journal-row{padding:10px 0;border-top:1px solid var(--background-modifier-border)}.journal-row:first-child{border-top:0}.journal-badge{display:inline-flex;align-items:center;min-height:22px;padding:var(--ke-space-1,2px) var(--ke-space-3,8px);border-radius:999px;font-size:var(--ke-type-label,.72rem);line-height:var(--ke-leading-control,1.35);font-weight:700}.journal-badge.complete{background:var(--background-modifier-success,var(--background-modifier-hover));color:var(--text-success,var(--text-normal))}.journal-badge.partial{background:var(--background-modifier-hover);color:var(--text-warning,var(--text-normal))}.journal-badge.empty{background:var(--background-modifier-hover);color:var(--text-muted)}.journal-block{border:1px solid var(--background-modifier-border);border-radius:6px;padding:8px 10px;margin:6px 0;background:var(--background-primary);font-size:var(--ke-type-body,.84rem);line-height:var(--ke-leading-body,1.45)}.journal-block-head{display:flex;align-items:center;gap:var(--ke-space-3)}.journal-block-delete{margin-left:auto}.journal-block .bid{font-size:var(--ke-type-chrome,.68rem);line-height:var(--ke-leading-control,1.35);color:var(--text-muted)}.journal-date-nav{display:flex;align-items:center;gap:var(--ke-space-3,8px);margin-bottom:10px}.journal-date-nav input[type=date]{border:1px solid var(--background-modifier-border);border-radius:6px;padding:var(--ke-space-2,4px) var(--ke-space-3,8px);background:var(--background-primary);color:var(--text-normal);font-size:var(--ke-type-body,.84rem);line-height:var(--ke-leading-control,1.35)}@media(max-width:${breakpoints.medium - 1}px){.prodigy-journal-workspace{padding:4px 4px 36px}.journal-card{padding:10px;margin-bottom:8px}.journal-card h2{font-size:var(--ke-type-heading,.92rem)}.journal-meta{font-size:var(--ke-type-label,.72rem)}.journal-preview{font-size:var(--ke-type-body,.84rem);line-height:var(--ke-leading-body,1.45)}.journal-primary-actions,.journal-actions{flex-wrap:wrap;gap:var(--ke-space-2,4px)}.journal-primary-actions .prodigy-btn,.journal-actions .prodigy-btn{flex:1 1 calc(50% - var(--ke-space-2,4px));min-height:${heights.touchTarget}px;font-size:var(--ke-type-label,.72rem);line-height:var(--ke-leading-control,1.35);text-align:center;box-sizing:border-box}.journal-block{padding:10px 12px;font-size:var(--ke-type-body,.84rem)}.journal-block-head{flex-wrap:wrap;gap:var(--ke-space-2,4px)}.journal-block .bid{font-size:var(--ke-type-chrome,.68rem)}.journal-block-delete{min-height:${heights.touchTarget}px;padding:var(--ke-space-2,4px) var(--ke-space-4,12px)}.journal-row{flex-wrap:wrap;gap:var(--ke-space-2,4px)}.journal-row .prodigy-btn{min-height:${heights.touchTarget}px;padding:var(--ke-space-2,4px) var(--ke-space-4,12px)}.journal-badge{font-size:var(--ke-type-label,.72rem);min-height:24px}.journal-date-nav{flex-wrap:wrap;gap:var(--ke-space-2,4px)}.journal-date-nav input[type=date]{flex:1 1 140px;min-height:${heights.touchTarget}px}}`;
    ...
    recent.slice(0, 14).forEach(function (item) {
      ...
      if (item.blockCount) left.createEl("span", { text: " \u00B7 " + item.blockCount + "\uBE14\uB85D", attr: { style: "color:var(--text-muted);font-size:var(--ke-type-label,.72rem);line-height:var(--ke-leading-body,1.45);margin-left:4px;" } });
