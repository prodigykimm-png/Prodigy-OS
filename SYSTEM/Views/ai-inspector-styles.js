(function (root) {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      ".prodigy-ai-inspector-close:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px}",
      ...
      ".prodigy-ai-inspector-citation:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px}",
      ...
      ".prodigy-ai-inspector-input:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px}",
      ...
      ".prodigy-ai-inspector-send:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px}",
      ...
      ".prodigy-ai-inspector-prompt:focus-visible{outline:2px solid var(--text-accent);outline-offset:2px}",
  ...
  function ensureShellStyles() {
    ...
    style.textContent = [
      ...
      ".prodigy-ai-inspector-resize:hover{background:var(--text-accent);opacity:0.3}",
      "}",
      "@media(prefers-reduced-motion:reduce){",
