...
const STATE_PATH = path.join(ROOT, "SYSTEM/CI/fixtures/consolidation/frontend-design-state.md");
...
function validateDesign(source) {
  ...
  for (const value of ["419 / 640 / 735 / 833 / 1023 / 1068 / 1440px", "52px", "44px", "min(70vh, 560px)", "min(38%, 420px)"]) {
