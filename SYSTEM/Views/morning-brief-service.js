(function (root) {
  ...
  function buildPrompt(morningPackage) {
    return [
      ...
      "- If context.yesterday_review is meaningful, include at most 2 short lines: 어제 배움 (learning or change) and 오늘 실험 (next_experiment).",
      "- Prefer next_experiment as something to continue today when relevant. Never invent learning or experiments.",
      "- If yesterday_review.missing is true, do not invent a reflection; keep the brief focused on Focus and deadlines.",
      "- If context.internal_context_line exists, you may use it as at most one short supporting clause. Do not label it as Memory.",
      "- Keep the entire brief readable within one minute. Avoid repeating the same fact twice.",
      "",
