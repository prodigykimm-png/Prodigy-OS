...
/**
 * sillim — zero-network typed provider adapter stub
 * Provider: sillim
 * Operator: 남서울경전철(주)
 * Scope: 신림선 stations
 * Source: https://sillimlrt.com/site/kr/
 *
 * Status: candidate (zero network dispatch)
 * Missing gate: Station detail/address and operator evidence not yet frozen
 *
...
const PROVIDER_ID = "sillim";
const OPERATOR = "남서울경전철(주)";
const SCOPE = "신림선 stations";
const SOURCE_URL = "https://sillimlrt.com/site/kr/";
const STATUS = "candidate";
const NETWORK_ALLOWED = false;
const MISSING_GATE = "Station detail/address and operator evidence not yet frozen";
