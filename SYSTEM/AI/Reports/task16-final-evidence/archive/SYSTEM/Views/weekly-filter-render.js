(function (root) {
  ...
  function renderKeyLearnings(parent, learnings) {
    var section = el(parent, "section", { attr: { class: "weekly-filter-section weekly-filter-key-learnings prodigy-full-bleed is-parchment" } });
    ...
    for (var i = 0; i < learnings.length; i++) {
      var card = el(section, "div", { attr: { class: "weekly-filter-learning-card prodigy-utility-card" } });
  ...
  function renderPatterns(parent, findings) {
    ...
    for (var i = 0; i < findings.length; i++) {
      var f = findings[i];
      var card = el(section, "div", { attr: { class: "weekly-filter-pattern-card prodigy-utility-card" } });
  ...
  function renderPrinciples(parent, principles) {
    ...
    for (var i = 0; i < principles.length; i++) {
      var p = principles[i];
      var card = el(section, "div", { attr: { class: "weekly-filter-principle-card prodigy-utility-card" } });
  ...
  function renderWeeklyReview(container, review) {
    container.empty();
    var wrapper = el(container, "div", { attr: { class: "weekly-filter-view prodigy-full-bleed", "aria-label": "주간 학습 리뷰" } });
