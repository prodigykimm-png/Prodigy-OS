(function (root) {
  ...
  if (!Number.isFinite(compactMax)) throw new Error("Auction Day requires the shared compact breakpoint.");
...
@media (forced-colors: active) {
  ...
  .prodigy-auction-day button:focus-visible,
  .prodigy-auction-day input:focus-visible,
  .prodigy-auction-day textarea:focus-visible { outline: 2px solid CanvasText; }
}
@media (prefers-reduced-motion: reduce) {
  .prodigy-auction-day * { animation: none !important; transition: none !important; scroll-behavior: auto !important; }
}
