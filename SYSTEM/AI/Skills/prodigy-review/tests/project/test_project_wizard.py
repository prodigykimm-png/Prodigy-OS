...
def assert_dashboard_entry_point() -> None:
    ...
    manifest_fixture = ROOT / "SYSTEM" / "AI" / "Skills" / "prodigy-review" / "tests" / "shared" / "fixtures" / "workspace-manifest-v1.json"
    project_manifest = json.loads(manifest_fixture.read_text(encoding="utf-8"))["entries"]["project"]["required"]
