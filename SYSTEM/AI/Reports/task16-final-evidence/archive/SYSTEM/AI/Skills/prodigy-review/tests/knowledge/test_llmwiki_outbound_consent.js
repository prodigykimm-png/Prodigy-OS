...
const CONFIG = Object.freeze({
  ...
  aiProfiles: {
    schema_version: 1,
    llmwiki: { direct_provider_key: "gemini", omniroute_provider_key: "openrouter" },
  },
});

function configWithDirectProvider(providerKey) {
  return {
    ...CONFIG,
    aiProfiles: { ...CONFIG.aiProfiles, llmwiki: { ...CONFIG.aiProfiles.llmwiki, direct_provider_key: providerKey } },
  };
}
