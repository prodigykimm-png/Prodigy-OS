(function (root) {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ".mv-shell{display:grid;gap:17px;min-inline-size:0}.mv-readiness h3,.mv-readiness p,.mv-ai h3,.mv-ai h4{margin:0}.mv-readiness p,.mv-principle-meta,.mv-status{color:var(--text-muted)}",
      ".mv-principle,.mv-ai,.mv-ai-item,.mv-readonly{display:grid;gap:8px;min-inline-size:0}.mv-principle-title{font-weight:700}.mv-actions{display:flex;gap:8px;flex-wrap:wrap;margin-block-start:8px}.mv-btn{min-block-size:44px;cursor:pointer}.mv-btn:focus-visible,.mv-form :focus-visible{outline:2px solid var(--ke-color-accent,var(--text-accent));outline-offset:2px}.mv-btn-danger,.mv-status-error{color:var(--text-error)}",
      ".mv-form{display:grid;gap:8px}.mv-form label{font-weight:700;color:var(--text-muted)}.mv-form input,.mv-form textarea,.mv-form select{inline-size:100%;min-block-size:44px;box-sizing:border-box;color:var(--text-normal);font:inherit}.mv-form textarea{min-block-size:88px;resize:vertical}",
      ".mv-ai-status,.mv-ai-item,.mv-readonly{overflow-wrap:anywhere;word-break:keep-all}.mv-ai-item{padding-block:8px;border-top:1px solid var(--background-modifier-border)}.mv-ai-list{margin:0;padding-inline-start:1.2em}",
      "@media(max-width:833px){.mv-actions .mv-btn{flex:1 1 calc(50% - 8px)}}@media(max-width:419px){.mv-actions .mv-btn{flex-basis:100%}}",
      "@media(forced-colors:active){.mv-btn-primary{border:2px solid Highlight}.mv-btn:focus-visible,.mv-form :focus-visible{outline-color:Highlight}}@media(prefers-reduced-motion:reduce){.mv-shell *{transition:none!important;animation:none!important;scroll-behavior:auto!important}}"
    ].join("");
  }
  ...
  function el(parent, tag, opts) {
    ...
    if (o.cls) {
      var classes = [o.cls];
      if (/\bmv-btn\b/.test(o.cls)) classes.push("prodigy-btn");
      if (/\bmv-btn-primary\b/.test(o.cls)) classes.push("prodigy-btn-primary");
      if (/\bmv-status\b/.test(o.cls)) classes.push("prodigy-status-line");
      if (/\b(?:mv-principle|mv-ai|mv-ai-item|mv-readonly)\b/.test(o.cls)) classes.push("prodigy-utility-card");
      if (/\bmv-readiness\b/.test(o.cls)) classes.push("prodigy-full-bleed", "is-parchment");
  ...
  function mount(options) {
    ...
    var shell = el(container, "div", { cls: "mv-shell prodigy-full-bleed" });
