(function (root) {
  ...
  const compactMax = Number(designTokens && designTokens.BREAKPOINTS && designTokens.BREAKPOINTS.medium || 768) - 1;

  const CSS = `.llmwiki-lifecycle{display:grid;gap:var(--ke-space-4);max-inline-size:100%;min-inline-size:0;min-block-size:0;color:var(--ke-color-text);font-size:var(--ke-type-body);line-height:var(--ke-leading-body)}.llmwiki-lifecycle,.llmwiki-lifecycle *{box-sizing:border-box}.llmwiki-lifecycle>*{max-inline-size:100%;min-inline-size:0}.llmwiki-lifecycle header,.llmwiki-lifecycle section,.llmwiki-lifecycle article,.llmwiki-lifecycle details{display:grid;gap:var(--ke-space-2);min-inline-size:0}.llmwiki-lifecycle h2,.llmwiki-lifecycle h3,.llmwiki-lifecycle p,.llmwiki-lifecycle dl{margin:0;word-break:keep-all;overflow-wrap:anywhere}.llmwiki-lifecycle h2{font-size:var(--ke-type-title);line-height:var(--ke-leading-control)}.llmwiki-lifecycle h3{font-size:var(--ke-type-heading);line-height:var(--ke-leading-control)}.llmwiki-lifecycle__intro,.llmwiki-lifecycle__source,.llmwiki-lifecycle__notice,.llmwiki-lifecycle details{padding:var(--ke-space-3);border:var(--ke-border-width) solid var(--ke-color-border);border-radius:var(--ke-radius-panel);background:var(--ke-color-surface-secondary)}.llmwiki-lifecycle__source-name{font-weight:var(--ke-font-weight-strong)}.llmwiki-lifecycle__muted{color:var(--ke-color-muted)}.llmwiki-lifecycle__error{color:var(--ke-color-error)}.llmwiki-lifecycle__actions{display:flex;flex-wrap:wrap;gap:var(--ke-space-2);min-inline-size:0}.llmwiki-lifecycle button,.llmwiki-lifecycle summary,.llmwiki-lifecycle input{font:inherit}.llmwiki-lifecycle button,.llmwiki-lifecycle summary{min-block-size:var(--ke-touch-target);max-inline-size:100%;padding:var(--ke-space-2) var(--ke-space-3);border:var(--ke-border-width) solid var(--ke-color-border);border-radius:var(--ke-radius-control);background:var(--ke-color-surface);color:var(--ke-color-text);line-height:var(--ke-leading-control);word-break:keep-all;overflow-wrap:anywhere}.llmwiki-lifecycle .llmwiki-approval-review button,.llmwiki-lifecycle .llmwiki-approval-review a{min-block-size:var(--ke-touch-target)!important}.llmwiki-lifecycle summary{display:flex;align-items:center;cursor:pointer}.llmwiki-lifecycle button{cursor:pointer}.llmwiki-lifecycle button[data-primary="true"]{background:var(--ke-color-interactive);border-color:var(--ke-color-interactive);color:var(--ke-color-on-interactive)}.llmwiki-lifecycle button:disabled,.llmwiki-lifecycle input:disabled{cursor:not-allowed;opacity:var(--ke-opacity-disabled)}.llmwiki-lifecycle button:focus-visible,.llmwiki-lifecycle summary:focus-visible,.llmwiki-lifecycle a:focus-visible,.llmwiki-lifecycle input:focus-visible{outline:var(--ke-focus-ring-width) solid var(--ke-color-accent);outline-offset:var(--ke-space-1)}.llmwiki-lifecycle__status{min-block-size:calc(var(--ke-space-5) * 2);padding:var(--ke-space-3);border-inline-start:var(--ke-focus-ring-width) solid var(--ke-color-accent);word-break:keep-all;overflow-wrap:anywhere}.llmwiki-lifecycle__status[data-state="error"]{border-inline-start-color:var(--ke-color-error);color:var(--ke-color-error)}.llmwiki-lifecycle__settings{display:grid;gap:var(--ke-space-3)}.llmwiki-lifecycle__setting{display:flex;align-items:flex-start;gap:var(--ke-space-2);min-block-size:var(--ke-touch-target);min-inline-size:0}.llmwiki-lifecycle__setting span{word-break:keep-all;overflow-wrap:anywhere}.llmwiki-lifecycle dl{display:grid;grid-template-columns:minmax(var(--ke-metadata-label-min),auto) minmax(0,1fr);gap:var(--ke-space-2) var(--ke-space-3)}.llmwiki-lifecycle dt{color:var(--ke-color-muted)}.llmwiki-lifecycle dd{margin:0;word-break:break-all;overflow-wrap:anywhere}.llmwiki-lifecycle__results{display:grid;gap:var(--ke-space-2);list-style:none;margin:0;padding:0}.llmwiki-lifecycle__results a{display:block;max-inline-size:100%;color:var(--ke-color-accent);word-break:break-all;overflow-wrap:anywhere}.llmwiki-lifecycle progress{inline-size:100%;max-inline-size:100%;accent-color:var(--ke-color-interactive)}@media(max-width:${compactMax}px){.llmwiki-lifecycle__actions button{flex:1 1 100%}.llmwiki-lifecycle dl{grid-template-columns:minmax(0,1fr)}}@media(prefers-reduced-motion:reduce){.llmwiki-lifecycle *{animation:none!important;transition:none!important;scroll-behavior:auto!important}}`;
  ...
  function mountLlmWikiLifecycleView(options = {}) {
    ...
    function statusRegion(parent, copy, state = "info") {
      return createEl(parent, "div", {
        text: copy,
        attr: {
          class: "llmwiki-lifecycle__status",
          role: "status",
          "aria-live": "polite",
          "aria-atomic": "true",
    ...
    function sourceContext(parent) {
      ...
      if (!name) return null;
      const section = createEl(parent, "section", { attr: { class: "llmwiki-lifecycle__source", "aria-label": "선택한 자료" } });
    ...
    function renderIdle(parent, copy = "자료를 선택하면 AI가 새 지식 또는 수정안을 제안합니다. 승인 전에는 저장되지 않습니다.") {
      const intro = createEl(parent, "section", { attr: { class: "llmwiki-lifecycle__intro" } });
